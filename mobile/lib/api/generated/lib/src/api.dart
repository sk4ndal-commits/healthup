...
class ApiClient {
  ...
  /// Get CultureApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  CultureApi getCultureApi() {
    return CultureApi(dio, serializers);
  }
