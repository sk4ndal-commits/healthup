...
class AuthApi {
  ...
  Future<Response<void>> apiV1AuthChangePasswordPost({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1AuthForgotPasswordPost({
    ...
    try {
      ...
      _bodyData = forgotPasswordRequest == null
          ? null
  ...
  Future<Response<void>> apiV1AuthLogoutPost({
    ...
    try {
      ...
      _bodyData = refreshRequest == null
          ? null
          : _serializers.serialize(refreshRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1AuthRegisterPost({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1AuthResetPasswordPost({
    ...
    try {
      ...
      _bodyData = resetPasswordRequest == null
          ? null
